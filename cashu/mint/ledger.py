...
class Ledger(
    ...
    async def mint_quote(
        ...
        elif invoice_obj is not None and invoice_obj.expiry is not None:
            expiry = invoice_obj.date + invoice_obj.expiry
        elif invoice_obj is None:
            # Non-BOLT11 backend (e.g., StripeWallet): configurable expiry
            expiry = now + settings.mint_non_bolt11_quote_expiry_seconds
